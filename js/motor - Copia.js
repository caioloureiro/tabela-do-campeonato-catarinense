...
$(document).ready(function (){
	...
	$.ajax({
		...
		success: function(retorno){
			...
			console.log('5. campeonato - Identifica os dados do campeonato através da URL => JSON:');
			console.log(campeonato);
			
			for(i = 0; i < campeonato.length; i++){
				
				if(campeonato[i].sAno == iAno){
					
					$('.menu-titulo').html(campeonato[i].sCampeonato);
					$('.menu-select-'+iAno).attr("selected","true");
					
					console.log('5.1. campeonato[i].sCampeonato - Monta o select do menu => STRING:');
			...
			$('.menu-select select').on('change', function() {
				...
				for(i = 0; i < campeonato.length; i++){
					...
					if(campeonato[i].sAno == this.value){
						
						campeonato_novo_id = campeonato[i].sNrID;
						
					}
					
				}
				
				url_nova = 'campeonato.html?SelStart1='+ this.value +'&SelStop1='+ this.value +'&SelStart2='+ campeonato_novo_id +'&SelStop2='+ campeonato_novo_id +'&SelStart3=&SelStop3=&SelStart4=&SelStop4=&SelStart5=&SelStop5=&RunReport=Run+Report';
			...
			console.log('5.2. contador - A contagem foi modificada para o próximo passo => NUMBER:');
			console.log(contador);
	...
	$.ajax({
		...
		success: function(retorno){
			...
			console.log('6. tabela - Identifica os dados da tabela => JSON:');
			console.log(tabela);
			
			console.log('6.1.1. tabela.length:');
			console.log(tabela.length);
			
			if(tabela.length >= 0 && tabela[0]){
			
				//Start - Carrossel de Tabelas
				console.log('6.2. Tabela da Fase de Turnos');
				...
				for(i = 0; i < tabela[0].Grupo[0].Tabela.length; i++){
					...
					console.log('6.2.1. Looping no Array Tabela: '+ i);
					...
					console.log('6.2.1.'+i+'. tabela[0].Grupo[0].Tabela[i].iPosicao - Definiu as posições:');
			...
			if(tabela.length > 0 && tabela[1]){
				...
				//Start - Carrossel de Tabelas
				console.log('6.3. Tabela das Quartas de Final');
			...
			if(tabela.length > 1 && tabela[2]){
				...
				//Start - Carrossel de Tabelas
				console.log('6.4. Tabela do Descenso');
			...
			if(tabela.length > 2 && tabela[3]){
				...
				//Start - Carrossel de Tabelas
				console.log('6.5. Tabela da Semi Final');
				...
				'		<div class="principal-tabela-classificacao-linha-info-btn-off principal-tabela-classificacao-linha-info-btn-on"></div>'+
				'	</div>'+
				'	<div class="principal-tabela-classificacao-linha-info-posicao">1º</div>'+
				...
				'		<div class="principal-tabela-classificacao-linha-info-btn-off principal-tabela-classificacao-linha-info-btn-on"></div>'+
				'	</div>'+
				'	<div class="principal-tabela-classificacao-linha-info-posicao">2º</div>'+
			...
			if(tabela.length > 3 && tabela[4]){
				...
				//Start - Carrossel de Tabelas
				console.log('6.6. Tabela da Final');
				...
				final_pos02 = tabela[4].Grupo[0].Tabela[1];
				//End - Ordena as posições de acordo com a TAG iPosicao FASE DE TURNOS
			...
			console.log('6.7. contador - A contagem foi modificada para o próximo passo => NUMBER:');
			console.log(contador);
		...
		success: function(retorno){
			...
			if(//1ª RODADA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select 1ª rodada');
					});
			...
			if(//2ª RODADA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select 2ª rodada');
					});
			...
			if(//3ª RODADA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select 3ª rodada');
					});
			...
			if(//4ª RODADA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select 4ª rodada');
					});
			...
			if(//5ª RODADA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select 5ª rodada');
					});
			...
			if(//6ª RODADA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select 6ª rodada');
					});
			...
			if(//7ª RODADA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select 7ª rodada');
					});
			...
			if(//8ª RODADA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select 8ª rodada');
					});
			...
			if(//9ª RODADA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select 9ª rodada');
					});
					
				}
			
			}
			if(//QUARTAS DE FINAL - IDA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select Quartas de Final - IDA');
					});
					
				}
			
			}
			if(//QUARTAS DE FINAL - VOLTA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select Quartas de Final - VOLTA');
					});
			...
			if(//DESCENSO - IDA
				...
				if(
					...
					console.log('Estamos no Descenso - IDA.');
					$('.principal-jogos-container').flickity({
						cellAlign: 'left',
						contain: true,
						pageDots: false,
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select Descenso - IDA');
					});
			...
			if(//DESCENSO - VOLTA
				...
				if(
					...
					console.log('Estamos no Descenso - VOLTA.');
					$('.principal-jogos-container').flickity({
						cellAlign: 'left',
						contain: true,
						pageDots: false,
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select Descenso - VOLTA');
					});
			...
			if(//SEMI FINAIS - IDA
				...
				if(
					...
					console.log('Estamos nas Semi Finais - IDA.');
					$('.principal-jogos-container').flickity({
						cellAlign: 'left',
						contain: true,
						pageDots: false,
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select Semi Finais - IDA');
					});
					
				}
			
			}
			if(//SEMI FINAIS - VOLTA
				...
				if(
					...
					console.log('Estamos nas Semi Finais - VOLTA.');
					$('.principal-jogos-container').flickity({
						cellAlign: 'left',
						contain: true,
						pageDots: false,
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select Semi Finais - VOLTA');
					});
			...
			if(//FINAIS - IDA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select Final - IDA');
					});
			...
			if(//FINAIS - VOLTA
				...
				if(
					...
					$(".principal-jogos-subtitulo").click(function(){
						...
						console.log('ver jogos de hoje: select Final - VOLTA');
					});
			...
			if(//PÓS CAMPEONATO
				...
				console.log('Este Campeonato está encerrado.');
				$('.principal-jogos-container').flickity({
					cellAlign: 'left',
					contain: true,
					pageDots: false,
				...
				$(".principal-jogos-subtitulo").click(function(){
					...
					console.log('ver jogos de hoje: select Este Campeonato está encerrado');
				});
			...
			//Start - Inserir jogos nas rodadas - SEMI FINAIS
			if(rodadas[15].sRodada == 'IDA FINAL'){
			...
			if(rodadas[16].sRodada == 'VOLTA FINAL'){
